...
const genDirNodeModules = path.join(process.cwd(), 'view', '$$_gendir', 'node_modules');
...
function getPlugins() {
  ...
  if (isProd) {
    plugins.push(new AngularCompilerPlugin({
      ...
      "platform": 0,
      "sourceMap": true,
      "tsConfigPath": "view/tsconfig.app.json",
...
module.exports = {
  ...
  "resolve": {
    ...
    "alias": { // WORKAROUND See. angular-cli/issues/5433
      "environments": isProd ? path.resolve(__dirname, 'view/environments/index.prod.ts') : path.resolve(__dirname, 'view/environments/index.ts')
    },
    "modules": [
      "./node_modules"
    ],
